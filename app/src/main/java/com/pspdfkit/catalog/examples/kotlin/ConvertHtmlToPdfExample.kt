 ...
 */
class ConvertHtmlToPdfExample(context: Context) :
    SdkExample(context, R.string.htmlToPdfConversionExampleTitle, R.string.htmlToPdfConversionExampleDescription) {
    override fun launchExample(context: Context, configuration: PdfActivityConfiguration.Builder) {
        ...
        WebViewSecurityPolicy.webViewSettingsCustomizer =
            object : WebViewSettingsCustomizer {
        ...
        val subscription =
            HtmlToPdfConverter
                .fromUri(context, "file:///android_asset/html-conversion/invoice.html".toUri())
