 ...
 */
fun preferenceSections(context: Context): List<PreferencesSection> = listOf(
    elements =
    arrayOf(
        PreferencesSection(
...
fun getRadioOptionStringFromEnumName(enumName: String, context: Context): String = when (enumName) {
    PageScrollDirection.HORIZONTAL.name -> {
        context.getString(R.string.page_scroll_direction_horizontal)
    }

    PageScrollDirection.VERTICAL.name -> {
        context.getString(R.string.page_scroll_direction_vertical)
    }

    PageLayoutMode.AUTO.name -> {
        context.getString(R.string.page_layout_auto)
    }

    PageLayoutMode.SINGLE.name -> {
        context.getString(R.string.page_layout_single)
    }

    PageLayoutMode.DOUBLE.name -> {
        context.getString(R.string.page_layout_double)
    }

    UserInterfaceViewMode.USER_INTERFACE_VIEW_MODE_AUTOMATIC.name -> {
        context.getString(R.string.user_interface_view_mode_automatic)
    }

    UserInterfaceViewMode.USER_INTERFACE_VIEW_MODE_AUTOMATIC_BORDER_PAGES.name -> {
        context.getString(
            R.string.user_interface_view_mode_automatic_border_pages,
        )
    }

    UserInterfaceViewMode.USER_INTERFACE_VIEW_MODE_HIDDEN.name -> {
        context.getString(R.string.user_interface_view_mode_hidden)
    }

    UserInterfaceViewMode.USER_INTERFACE_VIEW_MODE_MANUAL.name -> {
        context.getString(R.string.user_interface_view_mode_manual)
    }

    UserInterfaceViewMode.USER_INTERFACE_VIEW_MODE_VISIBLE.name -> {
        context.getString(R.string.user_interface_view_mode_visible)
    }

    ThumbnailBarMode.THUMBNAIL_BAR_MODE_PINNED.name -> {
        context.getString(R.string.thumbnail_bar_mode_pinned)
    }

    ThumbnailBarMode.THUMBNAIL_BAR_MODE_SCROLLABLE.name -> {
        context.getString(R.string.thumbnail_bar_mode_scrollable)
    }

    ThumbnailBarMode.THUMBNAIL_BAR_MODE_NONE.name -> {
        context.getString(R.string.thumbnail_bar_mode_none)
    }

    ThumbnailBarMode.THUMBNAIL_BAR_MODE_FLOATING.name -> {
        context.getString(R.string.thumbnail_bar_mode_floating)
    }

    AnnotationReplyFeatures.DISABLED.name -> {
        context.getString(R.string.annotation_reply_disabled)
    }

    AnnotationReplyFeatures.ENABLED.name -> {
        context.getString(R.string.annotation_reply_enabled)
    }

    AnnotationReplyFeatures.READ_ONLY.name -> {
        context.getString(R.string.annotation_reply_read_only)
    }
    ...
    ThemeMode.NIGHT.name -> {
        context.getString(R.string.theme_mode_night)
    }

    else -> {
        throw Exception("Failed to get Preference String from EnumName in PreferencesHelper.")
    }
}

fun getPageScrollDirectionFromString(value: String, context: Context): PageScrollDirection = when (value) {
...
fun getPageLayoutFromString(value: String, context: Context): PageLayoutMode = when (value) {
...
fun getUserInterfaceModeFromString(value: String, context: Context): UserInterfaceViewMode = when (value) {
...
fun getThumbnailBarModeFromString(value: String, context: Context): ThumbnailBarMode = when (value) {
...
fun getAnnotationReplyFeaturesFromString(value: String, context: Context): AnnotationReplyFeatures = when (value) {
...
fun getThemeModeFromString(value: String, context: Context): ThemeMode = when (value) {
