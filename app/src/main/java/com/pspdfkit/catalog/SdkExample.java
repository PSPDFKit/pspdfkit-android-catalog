 ...
 */
public abstract class SdkExample {
    // Documents used in our examples.
    public static final String QUICK_START_GUIDE = "Quickstart.pdf";
    ...
    public static class Section extends ArrayList<SdkExample> {
        @NonNull
        ...
        public Section(@NonNull final String name, @NonNull final Integer icon, @NonNull final SdkExample... examples) {
            this.name = name;
            this.iconId = icon;
        ...
        public Section(
                ...
                @NonNull final Collection<SdkExample> examples) {
            this.name = name;
            this.iconId = icon;
            addAll(examples);
        }
     ...
     */
    public SdkExample(@NonNull final String title, @NonNull final String description) {
        this.title = title;
     ...
     * Convenience constructor. Examples can pass their {@code title} and {@code description} here.
     */
    public SdkExample(@NonNull final Context context, @StringRes final int title, @StringRes final int description) {
