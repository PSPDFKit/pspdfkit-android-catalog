...
public class CustomToolbarIconGroupingExample extends SdkExample {
     ...
     */
    public static class CustomToolbarIconGroupingActivity extends PdfActivity
        ...
        public void onPrepareContextualToolbar(@NonNull ContextualToolbar toolbar) {
            if (toolbar instanceof AnnotationToolbar annotationToolbar) {
                annotationToolbar.setDraggable(false);
                annotationToolbar.setUseBackButtonForCloseWhenHorizontal(true);
                ...
                final List<ContextualToolbarMenuItem> menuItems = annotationToolbar.getMenuItems();
                ...
                annotationToolbar.setMenuItems(menuItems);

                // Add a listener so we can handle clicking on our item.
                annotationToolbar.setOnMenuItemClickListener((toolbar1, menuItem) -> {
                    if (menuItem.getId() == R.id.pspdf_menu_custom) {
                        Toast.makeText(
                                        CustomToolbarIconGroupingActivity.this,
                        ...
                        ContextualToolbarMenuItem imageItem =
                                toolbar1.findItemById(com.pspdfkit.R.id.pspdf__annotation_toolbar_item_image);
                        if (imageItem != null) {
                            toolbar1.setMenuItemVisibility(
                                    com.pspdfkit.R.id.pspdf__annotation_toolbar_item_image,
