 ...
 */
class LongTermValidationAfterSigningExample(context: Context) : PSPDFExample(context, R.string.digitalSignatureLtvAddedExampleTitle, R.string.digitalSignatureLtvAddedExampleDescription) {
