 ...
 */
class LongTermValidationExample(context: Context) : PSPDFExample(context, R.string.digitalSignatureLtvExampleTitle, R.string.digitalSignatureLtvExampleDescription) {
